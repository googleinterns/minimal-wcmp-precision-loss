...
SCIP_RETCODE FullTopology::PathILPCreateVariableGoal(SCIP *scip, SCIP_VAR *&u) {
...
SCIP_RETCODE FullTopology::PathILPCreateVariableF(SCIP *scip,
...
SCIP_RETCODE FullTopology::PathILPCreateVariableX(SCIP *scip,
...
SCIP_RETCODE FullTopology::PathILPCreateVariableY(SCIP *scip,
...
SCIP_RETCODE FullTopology::PathILPCreateVariableB(SCIP *scip,
...
SCIP_RETCODE FullTopology::PathILPCreateConstraints1(
  SCIP *scip,
...
SCIP_RETCODE FullTopology::PathILPCreateConstraints2(
  SCIP *scip,
...
SCIP_RETCODE FullTopology::PathILPCreateConstraints3(
  SCIP *scip,
...
SCIP_RETCODE FullTopology::PathILPCreateConstraints4(
  SCIP *scip,
...
SCIP_RETCODE FullTopology::PathILPCreateConstraints5(
  SCIP *scip,
...
// add constraints for (5)
SCIP_RETCODE FullTopology::PathILPCreateConstraints5_modified(
  SCIP *scip,
  std::vector<SCIP_CONS *> &cons_5,
  std::vector<std::vector<std::vector<SCIP_VAR *>>> &y,
  std::vector<std::vector<SCIP_VAR *>> &b) {
...
SCIP_RETCODE FullTopology::PathILPCreateConstraints6(
  SCIP *scip,
...
SCIP_RETCODE FullTopology::PathILPCreateConstraints9(
  SCIP *scip,
...
SCIP_RETCODE FullTopology::FindBestDcnRoutingPathILP() {
  SCIP *scip = nullptr;
