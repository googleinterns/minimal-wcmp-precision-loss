...
#include "ArcBasedILPSolver.h"

namespace wcmp {
namespace solver {

ArcBasedILPSolver::ArcBasedILPSolver(wcmp::topo::AbstractTopology topology, std::unordered_map<int, double> &trace): AbstractSolver(topology, trace) {

}

// create variable for MLU
SCIP_RETCODE ArcBasedILPSolver::ArcILPCreateVariableGoal(SCIP *scip, SCIP_VAR *&u) {
...
SCIP_RETCODE ArcBasedILPSolver::ArcILPCreateVariableF(SCIP *scip,
...
SCIP_RETCODE ArcBasedILPSolver::ArcILPCreateVariableX(SCIP *scip,
...
SCIP_RETCODE ArcBasedILPSolver::ArcILPCreateVariableY(SCIP *scip,
...
SCIP_RETCODE ArcBasedILPSolver::ArcILPCreateVariableB(SCIP *scip,
...
SCIP_RETCODE ArcBasedILPSolver::ArcILPCreateConstraints1(
  SCIP *scip,
...
SCIP_RETCODE ArcBasedILPSolver::ArcILPCreateConstraints2(
  SCIP *scip,
...
SCIP_RETCODE ArcBasedILPSolver::ArcILPCreateConstraints3(
  SCIP *scip,
...
SCIP_RETCODE ArcBasedILPSolver::ArcILPCreateConstraints4(
  SCIP *scip,
...
SCIP_RETCODE ArcBasedILPSolver::ArcILPCreateConstraints5(
  SCIP *scip,
...
SCIP_RETCODE ArcBasedILPSolver::ArcILPCreateConstraints6(
  SCIP *scip,
...
SCIP_RETCODE ArcBasedILPSolver::ArcILPCreateConstraints9(
  SCIP *scip,
...
SCIP_RETCODE ArcBasedILPSolver::FindBestRouting() {
  SCIP *scip = nullptr;
...
//void ArcBasedILPSolver::ArcILPResultAnalysis() {
